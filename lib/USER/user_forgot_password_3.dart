...
import '../main.dart';
class user_forgot_password3 extends StatefulWidget {
  var id;
  user_forgot_password3({required this.id});
  @override
  _user_forgot_password3State createState() => _user_forgot_password3State();
}
class _user_forgot_password3State extends State<user_forgot_password3> {
  ...
  Future submit() async {
    ...
    print("******");
    print(widget.id);
    var uri=Uri.parse("http://$ip/mainflutterdata/user/change_password_forgot.php?id=$ID");
