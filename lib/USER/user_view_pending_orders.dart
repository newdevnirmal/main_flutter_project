...
class user_view_pending_orders extends StatefulWidget {
  @override
  _user_view_pending_ordersState createState() => _user_view_pending_ordersState();
}
class _user_view_pending_ordersState extends State<user_view_pending_orders> {
//Applying get request.
  Future<List<login_model3>> getRequest() async {
    //replace your restFull API here.
    getdata();
    String url = "http://$ip/mainflutterdata/user/user_view_pending_orders.php?user_id=$data";
    print(url);
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Text("              status:   "),
                                        Text(
                                          snapshot.data[index].status,style: TextStyle(color:Colors.red),
                                        ),
                                      ],
                                    ),
                                    Text(
