...
import 'package:main_project/ADMIN/admin_forgot_password_2.dart';
...
import '../main.dart';
class admin_forgot_password1 extends StatefulWidget {
  const admin_forgot_password1({Key? key}) : super(key: key);
  @override
  State<admin_forgot_password1> createState() => _admin_forgot_password1State();
}
class _admin_forgot_password1State extends State<admin_forgot_password1> {
            ...
            child: Form(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    Padding(
                        padding: const EdgeInsets.only(top: 50.0, bottom: 70, left: 25, right: 0),
                        child: Text("ENTER  ADMIN  NAME  TO  START  THE  PASSWORD  RECOVERY  PROCESS", style: GoogleFonts.b612(
  ...
  Future<void> Submit() async {
    var APIURL =
        "http://$ip/mainflutterdata/admin/admin_forgot_password_1.php";
    ...
    if (data != null) {
      for (var user in data) {
        setState(() async {
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context) => admin_forgot_password2()));
        });
      }
    }
  }
