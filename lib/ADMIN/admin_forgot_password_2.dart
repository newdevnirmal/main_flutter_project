...
import '../main.dart';
import 'admin_forgot_password_3.dart';
class admin_forgot_password2 extends StatefulWidget {
  const admin_forgot_password2({Key? key}) : super(key: key);
  @override
  State<admin_forgot_password2> createState() => _admin_forgot_password2State();
}
class _admin_forgot_password2State extends State<admin_forgot_password2> {
  ...
  Future<void> Submit() async {
    var APIURL =
        "http://$ip/mainflutterdata/admin/admin_forgot_password_2.php";
    ...
    if (data != null) {
      for (var admin in data) {
        setState(() async {
          ...
          preflog.setString('id', admin['id']);
          print(admin['id']);
          Navigator.push(context, MaterialPageRoute(builder: (context) => admin_forgot_password3(id: admin['id'],)));
